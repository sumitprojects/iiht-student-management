        ...
        <tbody>
            <?php foreach ($applications->result_array() as $key => $application):
                ...
                <tr class="gradeU">
                    ...
                    <td>
                        <a href="javascript:void(0)" class="btn btn-primary" onclick="showAjaxModal('<?php echo site_url('modal/popup/application_details/'.$application['id']); ?>', '<?php echo get_phrase('applicant_details'); ?>')">
