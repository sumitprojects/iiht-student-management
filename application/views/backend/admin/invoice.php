                    ...
                    <div class="col-sm-4 offset-sm-2">
                        <div class="mt-3 float-sm-right">
                            <p class="font-13"><strong><?php echo get_phrase("requested_date"); ?>: </strong>
                                &nbsp;&nbsp;&nbsp; <?php echo date('D, d-M-Y', $payout_details['date_added']); ?></p>
                            <p class="font-13"><strong><?php echo get_phrase("payment_status"); ?>: </strong>
                                <?php if ($payout_details['status'] == 1): ?><span
                                    class="badge badge-success float-right"><?php echo get_phrase("paid"); ?></span><?php else: ?><span
                                    class="badge badge-danger float-right"><?php echo get_phrase("unpaid"); ?></span><?php endif; ?>
                            </p>
                            <p class="font-13"><strong><?php echo get_phrase("withdrawal_request_id"); ?>: </strong>
                                <span class="float-right"><?php echo sprintf('%04d', $payout_details['id']); ?></span>
                            </p>
                        </div>
                    </div><!-- end col -->
                </div>
