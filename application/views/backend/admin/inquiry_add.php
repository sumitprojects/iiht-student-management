    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                <h4 class="header-title mb-3"><?php echo get_phrase('inquiry_adding_form'); ?>
                    <a href="<?php echo site_url('admin/inquiry'); ?>" class="alignToTitle btn btn-outline-secondary btn-rounded btn-sm"> <i class=" mdi mdi-keyboard-backspace"></i> <?php echo get_phrase('back_to_course_list'); ?></a>
                </h4>

                <div class="row w-100">
                    <div class="col-xl-12">
                        <form class="required-form" action="<?php echo site_url('admin/inquiry_action/add'); ?>" method="post" enctype="multipart/form-data">
                            <div id="basicwizard">
