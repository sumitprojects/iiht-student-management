                                ...
                                <tbody>
                                    <?php foreach ($pending_applications->result_array() as $key => $pending_application):
                                        ...
                                        <tr class="gradeU">
                                            ...
                                            <td>
                                                <a href="javascript:void(0)" class="btn btn-primary" onclick="showAjaxModal('<?php echo site_url('modal/popup/application_details/'.$pending_application['id']); ?>', '<?php echo get_phrase('applicant_details'); ?>')">
                                ...
                                <tbody>
                                    <?php foreach ($approved_applications->result_array() as $key => $approved_application):
                                        ...
                                        <tr class="gradeU">
                                            ...
                                            <td>
                                                <a href="javascript:void(0)" class="btn btn-primary" onclick="showAjaxModal('<?php echo site_url('modal/popup/application_details/'.$approved_application['id']); ?>', '<?php echo get_phrase('applicant_details'); ?>')">
                                                    <i class="fa fa-info-circle"></i> <?php echo get_phrase('application_details'); ?>
                                                </a>
                                            </td>
                                            <td>
