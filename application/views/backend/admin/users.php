    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                <a href = "<?php echo site_url('admin/user_form/add_edit_from_inquiry'); ?>" class="btn btn-outline-primary btn-rounded alignToTitle"><i class="mdi mdi-plus"></i><?php echo get_phrase('add_admission'); ?></a>
                <a href = "<?php echo site_url('admin/user_form/add_edit_from_inquiry_non'); ?>" class="btn btn-outline-primary btn-rounded alignToTitle"><i class="mdi mdi-plus"></i><?php echo get_phrase('add_non_admission'); ?></a>
            </h4>
            </div> <!-- end card body-->
        </div> <!-- end card -->
    </div><!-- end col-->
                              ...
                              <td>
                                  <div class="dropright dropright">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a class="dropdown-item" href="<?php echo site_url('admin/users/view/'.$user['id']) ?>"><?php echo get_phrase('view'); ?></a></li>
