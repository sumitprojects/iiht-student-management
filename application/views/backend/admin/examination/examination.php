        ...
        <div class="card">
            <div class="card-body">
                <h4 class="page-title"> <i class="mdi mdi-apple-keyboard-command title_icon"></i>
                    <?php echo get_phrase('examination'); ?>
                  
                        <a href="<?php echo site_url('admin/manage_examination/examination_add_edit/'.$course_id); ?>"
                            class="btn btn-outline-primary btn-rounded alignToTitle"><i
                                class="mdi mdi-plus"></i><?php echo get_phrase('add_new_examination'); ?></a>
                </h4>
            </div> <!-- end card body-->
        </div> <!-- end card -->
    </div><!-- end col-->
...
<div class="row">
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                <h4 class="mb-3 header-title"><?php echo get_phrase('examination_list'); ?>
                </h4>
                <div class="table-responsive-sm mt-4">
                    <?php if (count($examination) > 0): ?>
                    <table id="examination-datatable" class="table table-striped dt-responsive nowrap" width="100%"
                        data-page-length='25'>
                        <thead>
                            <tr>
                                <th>#</th>
                        ...
                        <tbody>
                            <?php foreach ($examination as $key => $br):?>
                            <tr>
                                <td><?php echo ++$key; ?></td>
                                <td>
                                    ...
                                    <div class="dropright dropright">
                                        ...
                                        <ul class="dropdown-menu">
                                            ...
                                            <li><a class="dropdown-item"
                                                    href="<?php echo site_url('admin/manage_examination/examination_add_edit/'.$br['course_id'].'/'.$br['id']); ?>"><?php echo get_phrase('edit_this_examination');?></a>
                                            </li>
                                            <li><a class="dropdown-item" href="#"
                                                    onclick="confirm_modal('<?php echo site_url('admin/manage_examination/delete/'.$br['id']); ?>');"><?php echo get_phrase('delete'); ?></a>
                                            </li>
