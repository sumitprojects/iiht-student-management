    ...
    <ul class="metismenu side-nav side-nav-light">
        ...
        <li class="side-nav-item">
            <a href="<?php echo site_url('admin/branch'); ?>"
                class="side-nav-link <?php if ($page_name == 'branch' || $page_name == 'branch_add' || $page_name == 'branch_edit' ): ?> active <?php endif; ?>">
        ...
        <li class="side-nav-item">
            <a class="side-nav-link <?php if ($page_name == 'training_cat')echo 'active';?>"
        ...
        <?php endif; ?>
        <?php if((in_array('enrol_history', $this->session->userdata('permission')) && $this->session->userdata('role_id') != 1) ^ $this->session->userdata('role_id') == 1):?>
        <li
        ...
        <li class="side-nav-item">
            <a href="<?php echo site_url('admin/payment_list'); ?>" class="side-nav-link <?php if($page_name == 'payment_list') echo 'active'; ?>">
        ...
        <li class="side-nav-item">
            <a href="javascript: void(0);"
                class="side-nav-link <?php if ($page_name == 'department/department' || $page_name == 'department/department_add_edit' || $page_name == 'department/hod_add_edit' || $page_name == 'department/hod' ): ?> active <?php endif; ?>">
                <i class="dripicons-graph-pie"></i>
        ...
        <li class="side-nav-item">
            <a href="<?php echo site_url('admin/manage_schedule'); ?>"
                class="side-nav-link <?php if ($page_name == 'exam_schedule/schedule' || $page_name == 'exam_schedule/schedule_add_edit' ): ?> active <?php endif; ?>">
        ...
        <li class="side-nav-item">
            <a href="<?php echo site_url('admin/manage_leave'); ?>"
                class="side-nav-link <?php if ($page_name == 'leave/leave' || $page_name == 'leave/leave__add_edit' ): ?> active <?php endif; ?>">
                <i class="dripicons-contract"></i>
        ...
        <li class="side-nav-item">
            <a href="<?php echo site_url('admin/manage_attendance'); ?>"
                class="side-nav-link <?php if ($page_name == 'attendance/attendance' || $page_name == 'attendance/attendance_add_edit' ): ?> active <?php endif; ?>">
        ...
        <li class="side-nav-item">
            <a href="<?php echo site_url('admin/manage_email'); ?>"
                class="side-nav-link <?php if ($page_name == 'manage_email/email' || $page_name == 'manage_email/email_add_edit' ): ?> active <?php endif; ?>">
        ...
        <li class="side-nav-item">
            <a href="<?php echo site_url('admin/manage_sms'); ?>"
                class="side-nav-link <?php if ($page_name == 'manage_sms/sms' || $page_name == 'manage_sms/sms_add_edit' ): ?> active <?php endif; ?>">
                <i class="dripicons-message"></i>
        ...
        <li class="side-nav-item">
            <a href="<?php echo site_url('admin/manage_designation'); ?>"
                class="side-nav-link <?php if ($page_name == 'designation/designation' || $page_name == 'designation/designation_add_edit' ): ?> active <?php endif; ?>">
                <i class="dripicons-message"></i>
