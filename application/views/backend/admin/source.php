...
<div class="row">
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                <h4 class="mb-3 header-title"><?php echo get_phrase('source_list'); ?></h4>
                ...
                <?php if (count($source) > 0): ?>
                    <table id="source-datatable" class="table table-striped dt-responsive nowrap" width="100%" data-page-length='25'>
                        <thead>
                            <tr>
                                <th>#</th>
                                <th><?php echo get_phrase('source_name'); ?></th>
                                <th><?php echo get_phrase('source_status'); ?></th>
