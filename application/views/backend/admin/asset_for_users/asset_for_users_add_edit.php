            ...
            <div class="card-body">
                <div class="col-lg-12">
                    ...
                    <form class="required-form"
                        ...
                        <?php endif;?>
                        <?php if(empty($asset_for_users['user_id'])): ?>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" data-toggle="select2" name="asset_id[]" id="asset_id"
                                <?php echo !empty($asset_for_users)?'disabled':''?> required multiple>
                        ...
                        <div class="form-group">
                            ...
                            <select class="form-control select2" data-toggle="select2" name="status" id="status">
                                ...
                                <option value="Pending"
                                    <?php if($asset_for_users['status'] =='Pending') echo 'selected';?>>Pending</option>
                                <option value="Returned"
                                    <?php if($asset_for_users['status'] =='Returned') echo 'selected';?>>Returned
                                </option>
                                <option value="Approved"
                                    <?php if($asset_for_users['status'] =='Approved') echo 'selected';?>>Approved
                                </option>
                            </select>
                        </div>
