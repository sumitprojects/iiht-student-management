                        ...
                        <div class="tab-content b-0 mb-0">
                            ...
                            <div class="tab-pane" id="basic_info">
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <div class="form-group row mb-3">
                                            <label class="col-md-3 col-form-label" for="dob"><?php echo get_phrase('date_of_birth'); ?><span class="required">*</span></label>
                                            <div class="col-md-9">
                                                <input type="date" max="<?= date('Y-m-d') ?>" value="<?= $user_data['dob'] ?>" class="form-control" tabindex="0" id="dob" name="dob" required>
                                                <small><?php echo get_phrase("required_for_admission"); ?></small>
                                            </div>
                                        </div>
                                        <div class="form-group row mb-3">
                                            <label class="col-md-3 col-form-label" for="mob_no"><?php echo get_phrase('mob_no'); ?><span class="required">*</span></label>
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" tabindex="0" value="<?= $user_data['mob_no'] ?>" id="mob_no" name="mob_no" required>
                                                <small><?php echo get_phrase("required_for_admission"); ?></small>
                                            </div>
                                        </div>
                                        <div class="form-group row mb-3">
                                            <label class="col-md-3 col-form-label" for="alt_mob"><?php echo get_phrase('alt_mob'); ?></label>
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" tabindex="0" value="<?= $user_data['alt_mob'] ?>" id="alt_mob" name="alt_mob">
                                            </div>
                                        </div>
                                        <div class="form-group row mb-3">
                                            <label class="col-md-3 col-form-label" for="branch_id"><?php echo get_phrase('admission_branch'); ?><span class="required">*</span></label>
                                            <div class="col-md-9">
                                                <select class="form-control select2" data-toggle="select2" required name="branch_id" data-init-plugin="select2" id="branch_id">
                                                    <?php foreach ($branch as $key => $val) : ?>
                                                        <option value="<?= $val['branch_id'] ?>" <?= $user_data['branch_id'] == $val['branch_id'] ? 'selected' : '' ?>>
                            ...
                            <div class="tab-pane" id="social_information">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group row mb-3">
                                            <label class="col-md-3 col-form-label" for="marital_status"><?php echo get_phrase('marital_status'); ?><span class="required">*</span></label>
                                            <div class="col-md-9">
                                                <select class="form-control select2" data-toggle="select2" name="marital_status" data-init-plugin="select2" tabindex="0" id="marital_status">
                                                    <option value="single">
                                        ...
                                        <div class="form-group row mb-3">
                                            <label class="col-md-3 col-form-label" for="uid_or_adhaar"><?php echo get_phrase('uid_or_adhaar'); ?><span class="required">*</span></label>
                                            <div class="col-md-9">
                                                <input type="text" id="uid_or_adhaar" name="uid_or_adhaar" required value="<?= $user_data['uid_or_adhaar'] ?>" class="form-control" tabindex="0">
                                                <small><?php echo get_phrase("required_for_instructor"); ?></small>
                                            </div>
                                        </div>
                                        <div class="form-group row mb-3">
                                            <label class="col-md-3 col-form-label" for="present_address"><?php echo get_phrase('present_address'); ?><span class="required">*</span></label>
                                            <div class="col-md-9">
                                                <input type="text" id="present_address" name="present_address" value="<?= $address_details['present_address'] ?>" class="form-control" required tabindex="0">
                                                <small><?php echo get_phrase("required_for_admission"); ?></small>
                                            </div>
                                        </div>
                                        <div class="form-group row mb-3">
                                            <div class="offset-md-3 col-md-9">
                                                <div class="custom-control custom-checkbox">
                                                    <input type="checkbox" class="custom-control-input" tabindex="0" name="same_as_perm" id="same_as_perm" value="1">
                                                    <label class="custom-control-label" for="same_as_perm"><?php echo get_phrase('check_if_this_address_is_same_as_permanent'); ?></label>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row mb-3">
                                            <label class="col-md-3 col-form-label" for="permanent_address"><?php echo get_phrase('permanent_address'); ?><span class="required">*</span></label>
                                            <div class="col-md-9">
                                                <input type="text" id="permanent_address" value="<?= $address_details['permanent_address'] ?>" name="permanent_address" required class="form-control" tabindex="0">
                                                <small><?php echo get_phrase("required_for_admission"); ?></small>
                                            </div>
                                        </div>
                                        <div class="form-group row mb-3">
                                            <label class="col-md-3 col-form-label" for="education_detail"><?php echo get_phrase('education_detail'); ?><span class="required">*</span></label>
                                            <div class="col-md-9">
                                                <select class="form-control select2" data-toggle="select2" required name="education_detail" data-init-plugin="select2" tabindex="0" id="education_detail">
                                        ...
                                        <div class="form-group row mb-3">
                                            <label for="source_id" class="col-md-3 col-form-label"><?php echo get_phrase('inquiry_source'); ?><span class="required">*</span></label>
                                            <div class="col-md-9">
                                                <select class="form-control select2" required data-toggle="select2" name="source_id" data-init-plugin="select2" id="source_id">
                                        ...
                                        <div class="form-group">
                                            <label class="col-md-3 col-form-label" for="source_other"><?php echo get_phrase('reference_or_other'); ?><span class="required">*</span></label>
                                            <div class="col-md-9">
                                                <input type="text" class="form-control" id="source_other" value="<?= $user_data['source_other'] ?>" name="source_other">
                                            </div>
                                        </div>
                                    </div> <!-- end col -->
                                </div> <!-- end row -->
