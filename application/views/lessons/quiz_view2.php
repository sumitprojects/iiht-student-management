...
<div id="quiz-body">
    <div class="" id="quiz-header">
        ...
        <button type="button" name="button" class="btn btn-sign-up mt-2" style="color: #fff;"
            onclick="getStarted()"><?php echo get_phrase("get_started"); ?></button>
        <?php endif; ?>
    </div>
    ...
    <form class="" id="quiz_form" action="" method="post">
                    ...
                    <div class="card text-left quiz-card">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <strong><?php echo $quiz_question['title']; ?></strong></h6>
                                </div>
                                <div class="col-md-2">
                                     <label> (<?= $quiz_question['marks'];?>)</label>
                                </div>
                            </div>    
                        </div>
                        ...
                        <div class="form-group p-5">
                                ...
                                <textarea name="short_description" id="short_description"
                                    class="form-control" row="100" cols="500" onblur="enableNextButton('<?php echo $quiz_question['id'];?>')"></textarea>
                        </div>
                        <?php endif; ?>
                    </div>
                </div>
        ...
        <?php endforeach; ?>
         ...
         <button type="submit" name="button" class="btn btn-sign-up mt-2 mb-2" onclick="submitQuiz()"><?php echo get_phrase("submit"); ?>
         </button>
        <?php endif; ?>
    </form>
</div>
...
function submitQuiz() {
    $.ajax({
        url: '<?php echo site_url('home/submit_quiz/'.$course_id); ?>',
        type: 'post',
