    ...
    <div class="row justify-content-lg-between align-items-lg-center">
        ...
        <div class="col-lg-6">
            <div class="mb-5">
                ...
                <p class="lead">With our platform, you can quantify your skills, grow in your role and stay relevant on
                    critical topics.</p>
            </div>

            <div class="d-sm-flex align-items-sm-center flex-sm-wrap">
                <a class="btn btn-primary mb-2" href="../page-login.html">Start a Free Trial</a>
