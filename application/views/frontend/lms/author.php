...
<div class="js-sticky-block card card-bordered p-4" data-hs-sticky-block-options='{
    ...
    <div class="text-center">
        <!-- User Content -->
        <img class="img-fluid rounded-circle mx-auto" src="../assets/img/160x160/img2.jpg"
    ...
    <div class="border-top pt-4 mt-4">
        <div class="row">
            ...
            <div class="col-6 col-md-12 col-lg-6 mb-4">
                ...
                <div class="d-flex">
                    <span class="avatar avatar-xs mr-3">
                        <img class="avatar-img" src="../assets/svg/illustrations/star.svg"
                            alt="Image Description">
                    </span>
            ...
            <div class="col-6 col-md-12 col-lg-6 mb-4 col-6 col-md-12 mb-lg-0">
                ...
                <div class="d-flex">
                    <span class="avatar avatar-xs mr-3">
                        <img class="avatar-img" src="../assets/svg/illustrations/medal.svg"
                            alt="Image Description">
                    </span>
            ...
            <div class="col-6 col-md-12 col-lg-6">
                ...
                <div class="d-flex">
                    <span class="avatar avatar-xs mr-3">
                        <img class="avatar-img" src="../assets/svg/illustrations/add-file.svg"
                            alt="Image Description">
                    </span>
...
<div class="ml-lg-6">
    ...
    <div class="border-top pt-5 mt-5">
        <h3 class="mb-4">Courses taught by Nataly Gaga</h3>

        <!-- Course -->
        <div class="pt-0 mt-0">
            <a class="card shadow-none" href="course-description.html">
                <div class="card-body p-0">
                    <div class="row">
                        <div class="col-sm-5 col-lg-3 mb-3 mb-sm-0">
                            <img class="img-fluid rounded" src="../assets/svg/components/graphics-4.svg"
                                alt="Image Description">
                        </div>
                                ...
                                <div class="col-lg-6">
                                    <div class="row">
                                        ...
                                        <div class="col-5 text-right">
                                            ...
                                            <span
                                                class="d-block h5 text-primary text-lh-sm mb-0">$73.00</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="border-top pt-3 mt-3">
            <a class="card shadow-none" href="course-description.html">
                <div class="card-body p-0">
                    <div class="row">
                        <div class="col-sm-5 col-lg-3 mb-3 mb-sm-0">
                            <img class="img-fluid rounded" src="../assets/svg/components/graphics-6.svg"
                                alt="Image Description">
                        </div>
                        <div class="col-sm-7 col-lg-9">
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    <div class="row">
                                        ...
                                        <div class="col-5 text-right">
                                            ...
                                            <span
                                                class="d-block h5 text-primary text-lh-sm mb-0">$39.99</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="border-top pt-3 mt-3">
            <a class="card shadow-none" href="course-description.html">
                <div class="card-body p-0">
                    <div class="row">
                        <div class="col-sm-5 col-lg-3 mb-3 mb-sm-0">
                            <img class="img-fluid rounded" src="../assets/svg/components/graphics-5.svg"
                                alt="Image Description">
                        </div>
                        <div class="col-sm-7 col-lg-9">
                            <div class="row">
                                <div class="col-lg-6 mb-2 mb-lg-0">
                                    <h5 class="text-hover-primary">The Ultimate MySQL Bootcamp: Go from SQL
                                        Beginner to Expert</h5>
                                    <div class="d-flex align-items-center flex-wrap">
                                        <ul class="list-inline mt-n1 mb-0 mr-2">
                                            <li class="list-inline-item mx-0"><img
                                                    src="../assets/svg/illustrations/star.svg"
                                ...
                                <div class="col-lg-6">
                                    <div class="row">
                                        ...
                                        <div class="col-5 text-right">
                                            ...
                                            <span
                                                class="d-block h5 text-primary text-lh-sm mb-0">$89.99</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="text-right font-size-1 mt-6">
            <a class="font-weight-bold" href="listing.html">See all Courses <i
    ...
    <!-- Courses -->
    <div class="border-top pt-5 mt-5">
        <h3 class="h5 mb-4">Nataly's books</h3>
        ...
        <div class="row mx-n2 mx-lg-n3">
            ...
            <article class="col-sm-6 col-lg-4 px-2 px-lg-3 mb-3 mb-lg-0">
                <a class="card bg-img-hero w-100 min-h-270rem transition-3d-hover"
                    ...
                    <div class="card-body">
                        <span
                            class="d-block small text-white-70 font-weight-bold text-cap mb-2">Phython</span>
            ...
            <article class="col-md-6 col-lg-4 px-2 px-lg-3">
                <a class="card bg-img-hero w-100 min-h-270rem transition-3d-hover"
                    ...
                    <div class="card-body">
                        <span
                            class="d-block small text-white-70 font-weight-bold text-cap mb-2">Popular</span>
