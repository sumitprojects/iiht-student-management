...
<div class="container space-top-1">
    <div class="bg-primary rounded-lg"
        style="background: url(../assets/svg/illustrations/book.svg) right bottom no-repeat;">
        <div class="w-lg-50">
            <div class="py-8 px-6">
                <h1 class="display-4 text-white">Course catalog</h1>
                <p class="text-white mb-0">Front Course includes over <span class="font-weight-bold">20,000</span>
                    courses.</p>
            </div>
        </div>
    </div>
        ...
        <div class="col-lg-9">
                ...
                <div class="row mx-md-n2">
                    <div class="col-md-4 px-md-2 mb-3 mb-md-0">
                        <div class="position-relative">
                            <img class="img-fluid w-100 rounded-lg" src="../assets/svg/components/graphics-1.svg"
                                alt="Image Description">

                            <div class="position-absolute top-0 left-0 mt-3 ml-3">
                                <small
                                    class="btn btn-xs btn-success btn-pill text-uppercase shadow-soft py-1 px-2 mb-3">Bestseller</small>
                            </div>
                    ...
                    <div class="col-md-8">
                        <div class="media mb-2">
                            <div class="media-body mr-7">
                                <h3 class="text-hover-primary">Complete Python Bootcamp: Go from zero to hero in Python
                                    3</h3>
                            </div>
                        ...
                        <div class="d-flex justify-content-start align-items-center small text-muted mb-2">
                            <div class="d-flex align-items-center">
                                <div class="avatar-group">
                                    <span class="avatar avatar-xs avatar-circle" data-toggle="tooltip"
                        ...
                        <p class="font-size-1 text-body mb-0">Learn Python like a Professional! Start from the basics
                            and go all the way to creating your own applications and games!</p>
                    </div>
                </div>
            </a>
            <!-- End Card -->
            ...
            <a class="d-block border-bottom pb-5 mb-5" href="course-description.html">
                <div class="row mx-md-n2">
                    <div class="col-md-4 px-md-2 mb-3 mb-md-0">
                        <div class="position-relative">
                            <img class="img-fluid w-100 rounded-lg" src="../assets/svg/components/graphics-2.svg"
                                alt="Image Description">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="d-flex justify-content-start align-items-center small text-muted mb-2">
                            <div class="d-flex align-items-center">
                                <div class="avatar-group">
                                    <span class="avatar avatar-xs avatar-circle" data-toggle="tooltip"
                                        data-placement="top" title="Emily Milda">
                                        <img class="avatar-img" src="../assets/img/100x100/img2.jpg"
                                            alt="Image Description">
                                    </span>
                                    <span class="avatar avatar-xs avatar-circle" data-toggle="tooltip"
                                        data-placement="top" title="John O'nolan">
            ...
            <a class="d-block border-bottom pb-5 mb-5" href="course-description.html">
                <div class="row mx-md-n2">
                    <div class="col-md-4 px-md-2 mb-3 mb-md-0">
                        <div class="position-relative">
                            <img class="img-fluid w-100 rounded-lg" src="../assets/svg/components/graphics-4.svg"
                                alt="Image Description">
                    ...
                    <div class="col-md-8">
                        <div class="media mb-2">
                            <div class="media-body mr-7">
                                <h3 class="text-hover-primary">Get started with Vue.js</h3>
                            </div>

                            <div class="d-flex mt-1 ml-auto">
                                <div class="text-right">
                                    <small class="d-block text-muted text-lh-sm"><del>$169.99</del></small>
                                    <span class="d-block h5 text-primary text-lh-sm mb-0">$129.99</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <p class="font-size-1 text-body mb-0">Master Vue.js and build awesome, web apps with the
                            successor of Vue.js</p>
                    </div>
                </div>
            </a>
            <!-- End Card -->
            ...
            <a class="d-block border-bottom pb-5 mb-5" href="course-description.html">
                <div class="row mx-md-n2">
                    <div class="col-md-4 px-md-2 mb-3 mb-md-0">
                        <div class="position-relative">
                            <img class="img-fluid w-100 rounded-lg" src="../assets/svg/components/graphics-5.svg"
                                alt="Image Description">
                    ...
                    <div class="col-md-8">
                        <div class="media mb-2">
                            <div class="media-body mr-7">
                                <h3 class="text-hover-primary">The Ultimate MySQL Bootcamp: Go from SQL Beginner to
                                    Expert</h3>
                            </div>
                            ...
                            <div class="d-flex mt-1 ml-auto">
                                <div class="text-right">
                                    ...
                                    <span class="d-block h5 text-primary text-lh-sm mb-0">$111.99</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="d-flex justify-content-start align-items-center small text-muted mb-2">
                            <div class="d-flex align-items-center">
                                <div class="avatar-group">
                                    <span class="avatar avatar-xs avatar-circle" data-toggle="tooltip"
                                        data-placement="top" title="Hanna Wolfe">
            ...
            <a class="d-block border-bottom pb-5 mb-5" href="course-description.html">
                <div class="row mx-md-n2">
                    <div class="col-md-4 px-md-2 mb-3 mb-md-0">
                        <div class="position-relative">
                            <img class="img-fluid w-100 rounded-lg" src="../assets/svg/components/graphics-6.svg"
                                alt="Image Description">
                    ...
                    <div class="col-md-8">
                        <div class="media mb-2">
                            <div class="media-body mr-7">
                                <h3 class="text-hover-primary">Coding block for WordPress</h3>
                            </div>

                            <div class="d-flex mt-1 ml-auto">
                                <div class="text-right">
                                    <small class="d-block text-muted text-lh-sm"><del>$64.99</del></small>
                                    <span class="d-block h5 text-primary text-lh-sm mb-0">$29.99</span>
                                </div>
                            </div>
                        </div>
                        ...
                        <p class="font-size-1 text-body mb-0">Learn coding block from basics. Make your first 4 blocks
                            in Unreal engine. Interactive tutorial.</p>
                    </div>
                </div>
            </a>
            <!-- End Card -->
            ...
            <a class="d-block border-bottom pb-5 mb-5" href="course-description.html">
                <div class="row mx-md-n2">
                    <div class="col-md-4 px-md-2 mb-3 mb-md-0">
                        <div class="position-relative">
                            <img class="img-fluid w-100 rounded-lg" src="../assets/svg/components/graphics-3.svg"
                                alt="Image Description">
                    ...
                    <div class="col-md-8">
                        <div class="media mb-2">
                            <div class="media-body mr-7">
                                <h3 class="text-hover-primary">Creative Magazine Layout Design</h3>
                            </div>
                        ...
                        <div class="d-flex justify-content-start align-items-center small text-muted mb-2">
                            <div class="d-flex align-items-center">
                                <span class="avatar avatar-xs avatar-circle" data-toggle="tooltip" data-placement="top"
                                    title="Hanna Wolfe">
                                    <img class="avatar-img" src="../assets/img/100x100/img11.jpg"
                                        alt="Image Description">
                                </span>
                        ...
                        <p class="font-size-1 text-body mb-0">Master magazine layout design and publish awesome layout
                            designs.</p>
                    </div>
                </div>
            </a>
