...
<div class="container space-sm-2 space-bottom-lg-3">
        ...
        <article class="col-md-6 col-lg-4 mb-5">
            ...
            <div class="card card-bordered h-100">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        <h3>
                            <a class="text-inherit" href="course-description.html">Complete Python Bootcamp: Go from
        ...
        <article class="col-md-6 col-lg-4 mb-5">
            ...
            <div class="card card-bordered h-100">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        <h3>
                            <a class="text-inherit" href="course-description.html">From the Top: Adobe Illustrator for
                                Beginners</a>
                        </h3>
                    </div>
        ...
        <article class="col-md-6 col-lg-4 mb-5">
            ...
            <div class="card card-bordered h-100">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        <h3>
                            <a class="text-inherit" href="course-description.html">The Ultimate MySQL Bootcamp: Go from
                                SQL Beginner to Expert</a>
                        </h3>
                    </div>
                ...
                <div class="card-body">
                    ...
                    <div class="d-flex align-items-center mb-4">
                        <div class="avatar-group">
                            ...
                            <div class="avatar avatar-xs avatar-circle" data-toggle="tooltip" data-placement="top"
                                title="John O'nolan">
                                <img class="avatar-img" src="../assets/img/100x100/img4.jpg" alt="Image Description">
                            </div>
                        </div>
    ...
    <div class="text-center">
        <a class="font-weight-bold" href="listing.html">See all Courses <i class="fa fa-angle-right fa-sm ml-1"></i></a>
    </div>
</div>
<!-- Featured end -->
    ...
    <div class="position-relative bg-light text-center rounded z-index-2 mx-3 mx-md-11">
        <div class="container space-2">
            ...
            <div class="w-md-80 w-lg-50 text-center mx-md-auto mb-6">
                <div class="mb-3">
                    <div class="position-relative max-w-13rem mx-auto mb-2">
                        <img class="img-fluid" src="../assets/svg/illustrations/review-rating-shield.svg"
                            alt="Image Description">
                        <span
                            class="position-absolute top-0 right-0 left-0 z-index-2 text-white font-size-2 font-weight-bold mt-2">4.8</span>
                    </div>
            ...
            <div class="w-md-80 mx-md-auto mb-6">
                <blockquote class="font-size-2 text-dark">"The best part about Front Course is the selection. You can
                    find a course for anything you want to learn! Thank you Front Course! You've renewed my passion for
                    learning and my dream of becoming a web developer. I really enjoyed and now I work as a front-end
    ...
    <div class="w-lg-80 mx-lg-auto">
        <div class="row justify-content-center">
            <div class="col-4 col-sm-3 col-md mb-4">
                <img class="max-w-11rem max-w-md-13rem mx-auto" src="../assets/svg/clients-logo/airbnb.svg"
                    alt="Image Description">
            </div>
            <div class="col-4 col-sm-3 col-md mb-4">
                <img class="max-w-11rem max-w-md-13rem mx-auto" src="../assets/svg/clients-logo/slack.svg"
                    alt="Image Description">
            </div>
            <div class="col-4 col-sm-3 col-md mb-4">
                <img class="max-w-11rem max-w-md-13rem mx-auto" src="../assets/svg/clients-logo/fitbit.svg"
                    alt="Image Description">
            </div>
            <div class="col-4 col-sm-3 col-md mb-4">
                <img class="max-w-11rem max-w-md-13rem mx-auto" src="../assets/svg/clients-logo/hubspot.svg"
                    alt="Image Description">
            </div>
            <div class="col-4 col-sm-3 col-md mb-4">
                <img class="max-w-11rem max-w-md-13rem mx-auto" src="../assets/svg/clients-logo/weebly.svg"
                    alt="Image Description">
            </div>
        </div>
    </div>
