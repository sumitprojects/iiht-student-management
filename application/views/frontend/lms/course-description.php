        ...
        <div class="container">
            <div class="row">
                <div class="col-md-7 col-lg-8">
                    <small class="btn btn-xs btn-success btn-pill text-uppercase mb-2">Bestseller</small>
                    <h1 class="text-lh-sm">Complete Python Bootcamp: Go from zero to hero in Python 3</h1>
                    ...
                    <div class="d-flex align-items-center flex-wrap">
                        ...
                        <div class="d-flex align-items-center mr-4">
                            ...
                            <span class="pl-2">Created by <a class="link-underline" href="author.html">Nataly
                                    Gaga</a></span>
                        </div>
                        <!-- End Authors -->
                        ...
                        <div class="d-flex align-items-center flex-wrap">
                            <ul class="list-inline mt-n1 mb-0 mr-2">
                                <li class="list-inline-item mx-0"><img src="../assets/svg/illustrations/star.svg"
                                        alt="Review rating" width="16"></li>
                                <li class="list-inline-item mx-0"><img src="../assets/svg/illustrations/star.svg"
                                        alt="Review rating" width="16"></li>
                                <li class="list-inline-item mx-0"><img src="../assets/svg/illustrations/star.svg"
                                        alt="Review rating" width="16"></li>
                                <li class="list-inline-item mx-0"><img src="../assets/svg/illustrations/star.svg"
                                        alt="Review rating" width="16"></li>
                                <li class="list-inline-item mx-0"><img src="../assets/svg/illustrations/star-half.svg"
                                        alt="Review rating" width="16"></li>
                            </ul>
                ...
                <div class="js-sticky-block card card-bordered" data-hs-sticky-block-options='{
                   ...
                   "stickyOffsetBottom": 12
                    ...
                    <div class="position-relative p-1">
                        <!-- Video Popup -->
                        <a class="js-fancybox video-player" href="javascript:;" data-hs-fancybox-options='{
                     ...
                     "youtube": {
                       "autoplay": 1
                            ...
                            <img class="card-img-top" src="../assets/svg/components/graphics-1.svg"
                                alt="Image Description">
    ...
    <div class="row">
        <div class="col-md-7 col-lg-8">
            ...
            <div class="border-top pt-7 mt-7">
                ...
                <div class="card card-bordered overflow-hidden mb-1">
                    <div class="card-header card-collapse" id="coursesHeadingOne">
                        <a class="btn btn-link btn-sm btn-block card-btn p-3" href="javascript:;" role="button"
                            data-toggle="collapse" data-target="#coursesCollapseOne" aria-expanded="true"
                            aria-controls="coursesCollapseOne">
                            <!-- Header -->
                            <span class="row">
                                <span class="col-8">
                                    <span class="media">
                                ...
                                <div class="row">
                                    <div class="col-8">
                                        <a class="media font-size-1 mr-5" href="#">
                                            <i
                                                class="fa fa-play-circle min-w-3rem text-center opacity-lg mt-1 mr-2 ml-1"></i>
                                            <span class="media-body">
                ...
                <div class="card card-bordered overflow-hidden mb-1">
                    <div class="card-header card-collapse" id="coursesHeadingTwo">
                        <a class="btn btn-link btn-sm btn-block card-btn collapsed p-3" href="javascript:;"
                            role="button" data-toggle="collapse" data-target="#coursesCollapseTwo" aria-expanded="false"
                            aria-controls="coursesCollapseTwo">
                            <!-- Header -->
                            <span class="row">
                                <span class="col-8">
                                    <span class="media">
                ...
                <div class="card card-bordered overflow-hidden mb-1">
                    <div class="card-header card-collapse" id="coursesHeadingThree">
                        <a class="btn btn-link btn-sm btn-block card-btn collapsed p-3" href="javascript:;"
                            role="button" data-toggle="collapse" data-target="#coursesCollapseThree"
                            ...
                            <span class="row">
                                <span class="col-8">
                                    <span class="media">
                                        ...
                                        <span class="media-body">
                                            <span class="text-body font-weight-bold mr-5">Python object and data
                                                structure courses</span>
                                        </span>
                                    </span>
                                </span>
                                <span class="col-4 text-right">
                ...
                <div class="card card-bordered overflow-hidden mb-1">
                    <div class="card-header card-collapse" id="coursesHeadingFour">
                        <a class="btn btn-link btn-sm btn-block card-btn collapsed p-3" href="javascript:;"
                            role="button" data-toggle="collapse" data-target="#coursesCollapseFour"
                            ...
                            <span class="row">
                                <span class="col-8">
                                    <span class="media">
                                        ...
                                        <span class="media-body">
                                            <span class="text-body font-weight-bold mr-5">Python comparison
                                                operators</span>
                                        </span>
                                    </span>
                                </span>
                                    ...
                                    <div class="col-8">
                                        <span class="media text-body font-size-1 mr-5">
                                            <i
                                                class="fa fa-play-circle min-w-3rem text-center opacity-lg mt-1 mr-2 ml-1"></i>
                                            <span class="media-body">
                                                <span>Chaining Comparison Operators in Python with Logical
                                                    Operators</span>
                                            </span>
                                        </span>
                                    </div>
                ...
                <div class="card card-bordered overflow-hidden mb-1">
                    <div class="card-header card-collapse" id="coursesHeadingFive">
                        <a class="btn btn-link btn-sm btn-block card-btn collapsed p-3" href="javascript:;"
                            role="button" data-toggle="collapse" data-target="#coursesCollapseFive"
                ...
                <div class="collapse" id="collapseCoursesContentSection">
                    ...
                    <div class="card card-bordered overflow-hidden mb-1">
                        <div class="card-header card-collapse" id="coursesHeadingSix">
                            <a class="btn btn-link btn-sm btn-block card-btn collapsed p-3" href="javascript:;"
                                role="button" data-toggle="collapse" data-target="#coursesCollapseSix"
                                ...
                                <span class="row">
                                    <span class="col-8">
                                        <span class="media">
                                            ...
                                            <span class="media-body">
                                                <span class="text-body font-weight-bold mr-5">Modules and
                                                    packages</span>
                                            </span>
                                        </span>
                                    </span>
                    ...
                    <div class="card card-bordered overflow-hidden mb-1">
                        <div class="card-header card-collapse" id="coursesHeadingSeven">
                            <a class="btn btn-link btn-sm btn-block card-btn collapsed p-3" href="javascript:;"
                                role="button" data-toggle="collapse" data-target="#coursesCollapseSeven"
                                ...
                                <span class="row">
                                    <span class="col-8">
                                        <span class="media">
                                            ...
                                            <span class="media-body">
                                                <span class="text-body font-weight-bold mr-5">Errors and exceptions
                                                    handling</span>
                                            </span>
                                        </span>
                                    </span>
                ...
                <div class="card card-bordered">
                    <a class="link link-collapse btn btn-link btn-sm btn-block card-btn text-center p-3"
                        data-toggle="collapse" href="#collapseCoursesContentSection" role="button" aria-expanded="false"
                        aria-controls="collapseCoursesContentSection">
                        <span class="link-collapse-default">2 more sections</span>
            ...
            <div class="border-top pt-7 mt-7">
                ...
                <p>This is the most comprehensive, yet straight-forward, course for the Python programming language on
                    Udemy! Whether you have never programmed before, already know basic syntax, or want to learn about
                    the advanced features of Python, this course is for you! In this course we will teach you Python 3.
                    (Note, we also provide older Python 2 notes in case you need them)</p>

                <!-- Read More - Collapse -->
                <div class="collapse" id="collapseDescriptionSection">
                    <p>With over 100 lectures and more than 20 hours of video this comprehensive course leaves no stone
                        unturned! This course includes quizzes, tests, and homework assignments as well as 3 major
                        projects to create a Python project portfolio!</p>

                    <p>This course will teach you Python in a practical manner, with every lecture comes a full coding
                        screencast and a corresponding code notebook! Learn in whatever manner is best for you!</p>

                    <p>We will start by helping you get Python installed on your computer, regardless of your operating
                        system, whether its Linux, MacOS, or Windows, we've got you covered!</p>
                    ...
                    <p>This course comes with a 30 day money back guarantee! If you are not satisfied in any way, you'll
                        get your money back. Plus you will keep access to the Notebooks as a thank you for trying out
                        the course!</p>
                </div>
                        ...
                        <div class="card-body p-0">
                            <div class="row">
                                <div class="col-sm-5 col-lg-3 mb-3 mb-sm-0">
                                    <img class="img-fluid rounded-lg" src="../assets/svg/components/graphics-4.svg"
                                        alt="Image Description">
                                </div>
                                <div class="col-sm-7 col-lg-9">
                                    <div class="row">
                                        <div class="col-lg-6 mb-2 mb-lg-0">
                                            <h5 class="text-dark text-hover-primary">Get started with Vue.js</h5>
                                            <div class="d-flex align-items-center flex-wrap">
                                                <ul class="list-inline mt-n1 mb-0 mr-2">
                                        ...
                                        <div class="col-lg-6">
                                            <div class="row">
                                                ...
                                                <div class="col-5 text-right">
                                                    <small
                                                        class="d-block text-muted text-lh-sm"><del>$78.00</del></small>
                ...
                <div class="border-top pt-3 mt-3">
                    <a class="card shadow-none" href="#">
                        <div class="card-body p-0">
                            <div class="row">
                                <div class="col-sm-5 col-lg-3 mb-3 mb-sm-0">
                                    <img class="img-fluid rounded-lg" src="../assets/svg/components/graphics-6.svg"
                                        alt="Image Description">
                                </div>
                                <div class="col-sm-7 col-lg-9">
                                    <div class="row">
                                        <div class="col-lg-6 mb-2 mb-lg-0">
                                            <h5 class="text-dark text-hover-primary">Coding block for WordPress</h5>
                                            <div class="d-flex align-items-center flex-wrap">
                                                <ul class="list-inline mt-n1 mb-0 mr-2">
                                                    <li class="list-inline-item mx-0"><img
                                                            src="../assets/svg/illustrations/star.svg"
                                        ...
                                        <div class="col-lg-6">
                                            <div class="row">
                                                ...
                                                <div class="col-5 text-right">
                                                    <small
                                                        class="d-block text-muted text-lh-sm"><del>$59.99</del></small>
                ...
                <div class="border-top pt-3 mt-3">
                    <a class="card shadow-none" href="#">
                        <div class="card-body p-0">
                            <div class="row">
                                <div class="col-sm-5 col-lg-3 mb-3 mb-sm-0">
                                    <img class="img-fluid rounded-lg" src="../assets/svg/components/graphics-5.svg"
                                        alt="Image Description">
                                </div>
                                <div class="col-sm-7 col-lg-9">
                                    <div class="row">
                                        <div class="col-lg-6 mb-2 mb-lg-0">
                                            <h5 class="text-dark text-hover-primary">The Ultimate MySQL Bootcamp: Go
                                                from SQL Beginner to Expert</h5>
                                            <div class="d-flex align-items-center flex-wrap">
                                                <ul class="list-inline mt-n1 mb-0 mr-2">
                                                    <li class="list-inline-item mx-0"><img
                                                            src="../assets/svg/illustrations/star.svg"
                                        ...
                                        <div class="col-lg-6">
                                            <div class="row">
                                                ...
                                                <div class="col-5 text-right">
                                                    <small
                                                        class="d-block text-muted text-lh-sm"><del>$99.99</del></small>
            ...
            <div class="border-top pt-7 mt-7">
                ...
                <div class="row mx-n2 mx-lg-n3">
                    ...
                    <article class="col-sm-6 col-lg-4 px-2 px-lg-3 mb-3 mb-lg-0">
                        <a class="card bg-img-hero w-100 min-h-270rem transition-3d-hover" href="description.html"
                            style="background-image: url(../assets/img/400x500/img13.jpg);">
                            <div class="card-body">
                                <small
                                    class="d-block small text-white-70 font-weight-bold text-cap mb-2">Phython</small>
                    ...
                    <article class="col-sm-6 col-lg-4 px-2 px-lg-3 mb-3 mb-lg-0">
                        <a class="card bg-img-hero w-100 min-h-270rem transition-3d-hover" href="description.html"
                            ...
                            <div class="card-body">
                                <small
                                    class="d-block small text-white-70 font-weight-bold text-cap mb-2">Tooling</small>
                    ...
                    <article class="col-md-6 col-lg-4 px-2 px-lg-3">
                        <a class="card bg-img-hero w-100 min-h-270rem transition-3d-hover" href="description.html"
                            style="background-image: url(../assets/img/400x500/img17.jpg);">
                            <div class="card-body">
                                <small
                                    class="d-block small text-white-70 font-weight-bold text-cap mb-2">Popular</small>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="mb-2">
                            ...
                            <span class="d-block font-size-1 font-weight-bold">Head of Data Science, Pierian Data
                                Inc.</span>
                        </div>

                        <p>Nataly Gaga has a BS and MS in Mechanical Engineering from Santa Clara University and years
                            of experience as a professional instructor and trainer for Data Science and programming. She
                            has publications and patents in various fields such as microfluidics, materials science, and
                        ...
                        <div class="col-lg-4 mb-4 mb-lg-0">
                            ...
                            <div class="card bg-primary text-white text-center py-4 px-3">
                                ...
                                <ul class="list-inline mb-2">
                                    <li class="list-inline-item mr-1"><img src="../assets/svg/illustrations/star.svg"
                                            alt="Review rating" width="22"></li>
                                    <li class="list-inline-item mr-1"><img src="../assets/svg/illustrations/star.svg"
                                            alt="Review rating" width="22"></li>
                                    <li class="list-inline-item mr-1"><img src="../assets/svg/illustrations/star.svg"
                                            alt="Review rating" width="22"></li>
                                    <li class="list-inline-item mr-1"><img src="../assets/svg/illustrations/star.svg"
                                            alt="Review rating" width="22"></li>
                                    <li class="list-inline-item mr-1"><img
                                            src="../assets/svg/illustrations/star-half.svg" alt="Review rating"
                                            width="22"></li>
                                </ul>
                                    ...
                                    <a class="d-flex align-items-center font-size-1" href="javascript:;">
                                        ...
                                        <div class="d-flex align-items-center min-w-21rem ml-3">
                                            <ul class="list-inline mr-1 mb-2">
                                                <li class="list-inline-item mr-1"><img
                                                        src="../assets/svg/illustrations/star.svg" alt="Review rating"
                                                        width="16"></li>
                                                <li class="list-inline-item mr-1"><img
                                                        src="../assets/svg/illustrations/star.svg" alt="Review rating"
                                                        width="16"></li>
                ...
                <div class="border-top pt-5 mt-5">
                    <div class="row mb-2">
                        <div class="col-lg-4 mb-3 mb-lg-0">
                            ...
                            <div class="media align-items-center">
                                <div class="avatar avatar-circle mr-3">
                                    <img class="avatar-img" src="../assets/img/100x100/img12.jpg"
                                        alt="Image Description">
                                </div>
                                <div class="media-body">
                        ...
                        <div class="col-lg-8">
                            <ul class="list-inline mb-2">
                                <li class="list-inline-item mx-0"><img src="../assets/svg/illustrations/star.svg"
                                        alt="Review rating" width="16" height="16"></li>
                                <li class="list-inline-item mx-0"><img src="../assets/svg/illustrations/star.svg"
                                        alt="Review rating" width="16" height="16"></li>
                                <li class="list-inline-item mx-0"><img src="../assets/svg/illustrations/star.svg"
                                        alt="Review rating" width="16" height="16"></li>
                            ...
                            <p>This course helped me in learning python in a very simple and effective way &amp; boosts
                                up my confidence. Concepts have been explained in a crystal clear way.</p>
                        </div>
                    </div>
                ...
                <div class="border-top pt-5 mt-5">
                    <div class="row mb-2">
                        <div class="col-lg-4 mb-3 mb-lg-0">
                            ...
                            <div class="media align-items-center">
                                <div class="avatar avatar-circle mr-3">
                                    <img class="avatar-img" src="../assets/img/100x100/img8.jpg"
                                        alt="Image Description">
                                </div>
                                <div class="media-body">
                        ...
                        <div class="col-lg-8">
                            ...
                            <p>Master of Python, I took other classes also. I was very impressed, a very good teacher,
                                in detail explanations, easy to understand. I owe him many thanks and hopefully.
                                THAAAANK YOUU!</p>
                        </div>
                    </div>
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-lg-8">
                            <ul class="list-inline mb-2">
                                ...
                                <li class="list-inline-item mx-0"><img src="../assets/svg/illustrations/star.svg"
                                        alt="Review rating" width="16" height="16"></li>
                                <li class="list-inline-item mx-0"><img src="../assets/svg/illustrations/star-muted.svg"
                                        alt="Review rating" width="16" height="16"></li>
                            </ul>

                            <p>Section 19 needs to be addressed. the 1st topic in the section tells us it is optional
                                and can be skipped. this is not true and your instructions tell us to contact udemy
                                support if there is an issue. we did and they told us to contact you.</p>
                        </div>
                    </div>
        ...
        <div class="row">
            <article class="col-md-6 col-lg-4 mb-5">
                ...
                <div class="card card-bordered h-100">
                    ...
                    <div class="card-body">
                        <span class="d-block small font-weight-bold text-cap mb-2">Code</span>

                        <div class="mb-3">
                            <h3><a class="text-inherit" href="description.html">Complete Python Bootcamp: Go from zero
                                    to hero in Python 3</a></h3>
                        </div>

                        <div class="d-flex align-items-center">
                            <div class="avatar-group">
                                <a class="avatar avatar-xs avatar-circle" data-toggle="tooltip" data-placement="top"
                                    title="Nataly Gaga" href="#">
                                    <img class="avatar-img" src="../assets/img/100x100/img1.jpg"
                                        alt="Image Description">
                                </a>
                            </div>
                    ...
                    <div class="card-footer border-0 pt-0">
                        <div class="d-flex justify-content-between align-items-center">
                            ...
                            <a class="btn btn-sm btn-primary transition-3d-hover" href="description.html">Preview</a>
                        </div>
                    </div>
                </div>
                <!-- End Article -->
            ...
            <article class="col-md-6 col-lg-4 mb-5">
                ...
                <div class="card card-bordered h-100">
                    ...
                    <div class="card-body">
                        <span class="d-block small font-weight-bold text-cap mb-2">Design &amp; Illustration</span>

                        <div class="mb-3">
                            <h3><a class="text-inherit" href="description.html">From the Top: Adobe Illustrator for
                                    Beginners</a></h3>
                        </div>
                        ...
                        <div class="d-flex align-items-center mb-4">
                            <div class="avatar-group">
                                <a class="avatar avatar-xs avatar-circle" data-toggle="tooltip" data-placement="top"
                                    title="Emily Milda" href="#">
                                    <img class="avatar-img" src="../assets/img/100x100/img2.jpg"
                                        alt="Image Description">
                                </a>
                                <a class="avatar avatar-xs avatar-circle" data-toggle="tooltip" data-placement="top"
                                    title="John O'nolan" href="#">
                                    <img class="avatar-img" src="../assets/img/100x100/img4.jpg"
                                        alt="Image Description">
                                </a>
                            </div>
                            <div class="d-flex align-items-center ml-auto">
            ...
            <article class="col-md-6 col-lg-4 mb-5">
                ...
                <div class="card card-bordered h-100">
                    <div class="card-img-top position-relative">
                        ...
                        <div class="position-absolute top-0 left-0 mt-3 ml-3">
                            <small
                                class="btn btn-xs btn-success btn-pill text-uppercase shadow-soft mb-3">Featured</small>
                        </div>
                            ...
                            <div class="d-flex align-items-center flex-wrap">
                                <ul class="list-inline mt-n1 mb-0 mr-2">
                                    ...
                                    <li class="list-inline-item mx-0"><img src="../assets/svg/illustrations/star.svg"
                                            alt="Review rating" width="14"></li>
                                    <li class="list-inline-item mx-0"><img
                                            src="../assets/svg/illustrations/star-muted.svg" alt="Review rating"
                                            width="14"></li>
                                </ul>
                                <span class="d-inline-block">
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <h3><a class="text-inherit" href="description.html">Get started with Vue.js</a></h3>
                        </div>

                        <div class="d-flex align-items-center mb-4">
                            <div class="avatar-group">
                                <a class="avatar avatar-xs avatar-circle" data-toggle="tooltip" data-placement="top"
                                    title="Aaron Larsson" href="#">
                                    <img class="avatar-img" src="../assets/img/100x100/img3.jpg"
                                        alt="Image Description">
                                </a>
                                <a class="avatar avatar-xs avatar-circle" data-toggle="tooltip" data-placement="top"
                                    title="Hanna Wolfe" href="#">
