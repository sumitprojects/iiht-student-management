                        ...
                        <table id="assetusers" data-filter="2,3,4,5" class="table table-striped dt-responsive nowrap"
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <?php if($br['att_status'] != 'approved' && $br['att_status'] != 'rejected'): ?>
                                    <td>
                                        <div class="dropright dropright">
                                            ...
                                            <ul class="dropdown-menu">
                                                ...
                                                <li><a class="dropdown-item"
                                                        href="<?php echo site_url('home/leave_request/approved/'.$br['id']); ?>"><?php echo get_phrase('approved');?></a>
                                                </li>
                                                ...
                                                <li><a class="dropdown-item"
                                                        href="<?php echo site_url('home/leave_request/rejected/'.$br['id']); ?>"><?php echo get_phrase('rejected');?></a>
                                                </li>
                                            </ul>
