        ...
        <div class="box_grid">
          <figure>
            ...
            <a href="<?php echo site_url('home/course/' . slugify($latest_course['title']) . '/' . $latest_course['id']); ?>">
              <div class="preview"><span><?php echo get_phrase('preview_course'); ?></span></div><img src="<?php echo $this->crud_model->get_course_thumbnail_url($latest_course['id']); ?>" class="img-fluid" alt="">
            </a>
