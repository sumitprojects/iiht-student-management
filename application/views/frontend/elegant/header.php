<header class="header menu_2 d-print-none">
    ...
    <ul id="top_menu">
            <li><a href="<?php echo site_url('home/shopping_cart'); ?>"
                    class="shopping_cart"><?php echo get_phrase('shopping_cart'); ?></a></li>
            ...
            <li class=""><a href="<?php echo site_url('login/logout'); ?>"
                    class="btn_1 rounded"><?php echo get_phrase('log_out'); ?></a></li>
            <?php else: ?>
            <li class=""><a href="<?php echo site_url('home/login'); ?>"
                    class="btn_1 rounded"><?php echo get_phrase('login'); ?></a></li>
            <?php endif; ?>
        </ul>
    <!-- /top_menu -->
    ...
    <nav id="menu" class="main-menu">
        <ul>
            ...
            foreach ($parent_categories as $key => $parent_category): ?>
                    <li><a
                            href="<?php echo site_url('home/courses?category='.$parent_category['slug']); ?>"><?php echo $parent_category['name']; ?></a>
                    </li>
                    <?php endforeach; ?>
                    <li class="highlighter-menu"><a
                            href="<?php echo site_url('home/courses'); ?>"><?php echo get_phrase('all_courses'); ?></a>
                    </li>
                </ul>
            </li>
            ...
            <li>
                ...
                <ul>
                    ...
                    <li><a
                            href="<?php echo site_url('home/my_wishlist'); ?>"><?php echo get_phrase('my_wishlist'); ?></a>
                    </li>
                    <li><a
                            href="<?php echo site_url('home/my_messages'); ?>"><?php echo get_phrase('my_messages'); ?></a>
                    </li>
                    <li><a
                            href="<?php echo site_url('home/purchase_history'); ?>"><?php echo get_phrase('purchase_history'); ?></a>
                    </li>
                    <li><a
                            href="<?php echo site_url('home/profile/user_profile'); ?>"><?php echo get_phrase('user_profile'); ?></a>
                    </li>
                </ul>
            </li>
            <?php endif; ?>
